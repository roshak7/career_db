...
OTSTUP_V = 40 #40
OTSTUP_H = 80 #80
OTSTUP_HB = 90  # 90 расстояние между блоками
DOLZH_HS = 100 # 100
DOLZH_WS = 400 #400
    ...
    if lsize > 0:
        ...
        try:
            if jdata[1]['full_size'][0]<500:
                jdata[0]['x'] = jdata[0]['x'] + jdata[1]['full_size'][0] - DOLZH_WS / 2 + OTSTUP_H / 2
            else:
                jdata[0]['x'] = jdata[0]['x'] + jdata[1]['full_size'][0] - DOLZH_WS / 2 + OTSTUP_H / 2 - 29.5
        except:
            jdata[0]['x']=800
            jdata[0]['y']=jdata[0]['y']+100
